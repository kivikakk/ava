...
pub const Opcode = enum(u8) {
    ...
    OPERATOR_FDIVIDE_INTEGER = 0xde,
    OPERATOR_FDIVIDE_LONG = 0xdf,
    OPERATOR_FDIVIDE_SINGLE = 0xe0,
    OPERATOR_FDIVIDE_DOUBLE = 0xe1,
    OPERATOR_IDIVIDE_INTEGER = 0xe2,
    OPERATOR_IDIVIDE_LONG = 0xe3,
    OPERATOR_IDIVIDE_SINGLE = 0xe4,
    OPERATOR_IDIVIDE_DOUBLE = 0xe5,
