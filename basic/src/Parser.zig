...
fn parseAll(self: *Parser) ![]ast.Stmt {
...
fn parseOne(self: *Parser) (Error || Allocator.Error)!?ast.Stmt {
    if (self.eoi())
        return null;
...
fn append(self: *Parser, s: ast.Stmt) !void {
...
fn acceptFactor(self: *Parser) !?ast.Expr {
...
fn acceptTerm(self: *Parser) !?ast.Expr {
...
fn acceptExpr(self: *Parser) (Allocator.Error || Error)!?ast.Expr {
...
fn acceptCond(self: *Parser) !?ast.Expr {
...
fn acceptExprList(self: *Parser, comptime septoks: []const Token.Tag, separators: ?*std.ArrayListUnmanaged(Token), trailing: bool) !?[]ast.Expr {
...
fn acceptBuiltinPrint(self: *Parser, l: WithRange([]const u8)) !?ast.Stmt {
    if (try self.peekTerminator()) {
...
fn acceptStmtLabel(self: *Parser) !?ast.Stmt {
...
fn acceptStmtLet(self: *Parser) !?ast.Stmt {
...
fn acceptStmtIf(self: *Parser) !?ast.Stmt {
...
fn acceptStmtFor(self: *Parser) !?ast.Stmt {
...
fn acceptStmtNext(self: *Parser) !?ast.Stmt {
...
fn acceptStmtGoto(self: *Parser) !?ast.Stmt {
...
fn acceptStmtEnd(self: *Parser) !?ast.Stmt {
